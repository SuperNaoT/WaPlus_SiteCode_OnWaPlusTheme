<?php
  ...
  // require_once get_theme_file_path( 'WaPlusCfg/common-php/_DEBUG-Setting.php' );
  require_once( get_template_directory() . '/WaPlusCfg/common-php/_DEBUG-Setting.php' );
